<link rel="stylesheet" type="text/css" href="{_MODULE_DIR_}/Modul_debitare/custom_css/product_cart.css">
		...
		<div class="row">
			<div class="col-xs-12">
				<form action="" method="post" class="contact-form-box" enctype="multipart/form-data">
					...
					<button type="button" class="button btn btn-default modal-btn-p" data-toggle="modal" data-target="#cartModal" id="{$product_id}"><img src="{$debitare_blue_img_url}"  /></button>
								...
								<div class="modal-body">
									...
									<div class="modal-header-select">
										<div class="select-custom">
											...
											<div class="form-group">
												<div class="CartPageProduct_id">
												</div>
												<select class="form-control modal_input" name="warehouse_name" id="warehousesCart">
													<option value="-1">Alege depozit Regency</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="table-responsive">
												<table class="table table-bordered table-striped" id="product_data">
													<thead>
														<tr>
															<th>Denumire / numar piesa</th>
															<th>Inaltime(mm)</th><th>Latime(mm)</th>
															<th>Cantitate</th><th class="rot-width">Rotire</th>
															<th class="width-class">Aplicare cant</th>
															<th></th>
														</tr>
													</thead>
													<tbody>
					...
					<div class="modal fade" id="cartAngleModal" role="dialog">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="container-fluid">
										...
										<div class="cust-product-box">
											...
											<div class="cust-radio">
												<div class="form-group">
												  <p>
													<input type="radio" id="Cart_cant_col_pal" name="color_pale" value="color_not_add" class="modal_input color_pale_cart" checked>
													<label for="Cart_cant_col_pal">Cant la culoarea palului</label>
												  </p>
												  <p>
													<input type="radio" id="cart_all_col_pal" class="modal_input color_pale_cart" name="color_pale" value="color_add">
													<label for="cart_all_col_pal">Toate culorile</label>
												  </p>
												</div>
												<div class="content-cust">
													<span class="Product_size_cart">120 x 80 cm</span>
											...
											<div class="form-group edging_div">
												...
												<div class="cust-slect">
													<select class="form-control modal_input" name="edging_category" id="category_listsCart">
											...
											<div class="form-group">
												...
												<div class="cust-slect">
													...
													<select class="form-control modal_input" name="CatProducts_fată" id="CatProductsCart_fată">
											...
											<div class="form-group">
												...
												<div class="cust-slect">
													<select class="form-control modal_input" name="CatProducts_spate" id="CatProductsCart_spate">
											...
											<div class="form-group">
												...
												<div class="cust-slect ">
													<select class="form-control modal_input" name="CatProducts_dreapta" id="CatProductsCart_dreapta">
											...
											<div class="form-group">
												...
												<div class="cust-slect">
													<select class="form-control modal_input" name="CatProducts_stanga" id="CatProductsCart_stanga">
								...
								<div class="modal-footer">
								  <button type="button" class="common_cart_btn">Aplicare cant</button>
								</div>
							</div>
						</div>
					</div>
